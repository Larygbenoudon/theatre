...
class ProductionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post productions_url, params: { production: { adresse: @production.adresse, description: @production.description, manager_id: @production.manager_id, name: @production.name, photo: @production.photo } }
    end
  ...
  test "should update production" do
    patch production_url(@production), params: { production: { adresse: @production.adresse, description: @production.description, manager_id: @production.manager_id, name: @production.name, photo: @production.photo } }
