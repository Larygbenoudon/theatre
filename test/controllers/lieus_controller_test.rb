...
class LieusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lieu" do
    assert_difference('Lieu.count') do
      post lieus_url, params: { lieu: { adresse: @lieu.adresse, name: @lieu.name, photo: @lieu.photo, theatre_id: @lieu.theatre_id } }
    end
  ...
  test "should update lieu" do
    patch lieu_url(@lieu), params: { lieu: { adresse: @lieu.adresse, name: @lieu.name, photo: @lieu.photo, theatre_id: @lieu.theatre_id } }
